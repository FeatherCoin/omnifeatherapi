  ...
  if ERMAX > pmaxid:
    book=dbSelect("select sp.propertyname, rates.* from smartproperties sp join "
                ...
                "on CASE WHEN rates.protocol1='Fiat' "
                  ...
                  "ELSE rates.propertyid2=sp.propertyid and (sp.protocol='Omni' or sp.protocol='Feathercoin') END")
  return book,ERMAX
...
def getCurrentPriceRaw(input):
  ...
  if input[:2].upper() == "SP":
    protocol1='Feathercoin'
    pid1=getPropertyid('FTC', protocol1)
    protocol2 = 'Omni'
    ...
    protocol2='Feathercoin'
    pid2=getPropertyid('FTC', protocol2)
